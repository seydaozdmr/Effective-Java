package com.effectivejava.I_Exceptions.UseExceptionsOnlyForExceptionalConditions;
...
//        }
         ...
         * indicating whether it is appropriate to invoke the state-dependent method.
         * For example, the Iterator interface has the state-dependent method next and the
         ...
         * method return an empty optional (Item 55) or a distinguished value
